...
class MovieLensGraph(InMemoryDataset):
    ...
    Adapted from https://pytorch-geometric.readthedocs.io/en/latest/_modules/torch_geometric/datasets/movie_lens.html#MovieLens,
    modified to include temporal information using rating time stamps
